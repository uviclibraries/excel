...
- NOTE: If you don’t have the latest version of Microsoft Excel, you can request a UVic licensed and paid-for version of [Office 365 here](https://onlineservices.uvic.ca/){:target="_blank"} however, not all activities are possible with this version. Several functions from the desktop version are not available on the web app (e.g. add chart elements => trendline).
